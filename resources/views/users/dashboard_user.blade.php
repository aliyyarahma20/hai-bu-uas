            ...
            <div class="p-4">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        ...
                        <a href="{{route('dashboard.learning.index')}}" class="w-full text-left bg-[#4B5945] rounded-xl p-6 transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
