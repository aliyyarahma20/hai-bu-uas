            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('dashboard.module-bahasa.update', $modules)}}" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input value="{{$modules->description}}" type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Tuliskan isi modul" name="description" required>
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <button type="submit" href="index.html" class="w-full h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Save Course</button>
                </div>
            </form>
        </div>
    </section>
