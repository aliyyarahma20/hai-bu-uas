...
<div class="flex flex-col px-5 mt-5">
    <div class="w-full flex justify-between items-center">
        <div class="flex flex-col gap-1">
            <p class="font-extrabold text-[30px] leading-[45px]">Kamus Bahasa</p>
            <p class="text-[#7F8190]">Manajemen kamus setiap bahasa</p>
        </div>
    </div>
</div>
<div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
    <div class="course-list-header flex flex-nowrap justify-between pb-4 pr-10 border-b border-[#EEEEEE]">
        ...
        <div class="flex justify-center shrink-0 w-[300px]">
    ...
    {{-- @forelse ($kamus) --}}
        <div class="list-items flex flex-nowrap justify-between pr-10">
            ...
            <div class="flex shrink-0 w-[300px] justify-center">
                <p class="font-semibold"></p>
            </div>
            {{-- @if($modul->category->name == "Bahasa Sunda" or $modul->category->name == "Bahasa Minangkabau") --}}
                <div class="flex w-[170px]">
                    <p class="p-[8px_16px] rounded-full bg-[#FFF2E6] font-bold text-sm text-[#F6770B]"></p>
                </div>
