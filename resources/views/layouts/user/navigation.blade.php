...
<a href="{{ route('dashboard') }}" 
   ...
   {{ $routeName == 'dashboard' ? 'text-[#4B5945] border-l-4 border-l-[#4B5945] bg-[#F3F8F2]' : 'text-gray-600 hover:text-[#4B5945] hover:border-l-4 hover:border-l-[#4B5945]' }}">
...
<a href="fix-modules.html" 
   class="flex cursor-pointer items-center py-3 px-4 text-sm font-medium 
   {{ str_contains($routeName, 'modules') ? 'text-[#4B5945] border-l-4 border-l-[#4B5945] bg-[#F3F8F2]' : 'text-gray-600 hover:text-[#4B5945] hover:border-l-4 hover:border-l-[#4B5945]' }}">
    <svg class="mr-4 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<a href="fix-leaderboard.html" 
   class="flex cursor-pointer items-center py-3 px-4 text-sm font-medium 
   {{ str_contains($routeName, 'leaderboard') ? 'text-[#4B5945] border-l-4 border-l-[#4B5945] bg-[#F3F8F2]' : 'text-gray-600 hover:text-[#4B5945] hover:border-l-4 hover:border-l-[#4B5945]' }}">
...
<a href="#" 
   class="flex cursor-pointer items-center py-3 px-4 text-sm font-medium 
   {{ str_contains($routeName, 'dictionary') ? 'text-[#4B5945] border-l-4 border-l-[#4B5945] bg-[#F3F8F2]' : 'text-gray-600 hover:text-[#4B5945] hover:border-l-4 hover:border-l-[#4B5945]' }}">
