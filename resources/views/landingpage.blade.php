...
<head>
    ...
    <header class="text-slate-700 relative mx-auto flex flex-col overflow-hidden px-8 py-8 lg:flex-row lg:items-center bg-white  sticky  top-0 w-full z-50">
        ...
        <div class="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
            <a href="{{route('register')}}" class="text-sm/7 font-semibold text-white mr-4 px-8 py-2 rounded-md bg-[#4B5945] hover:bg-[#B2C9AD] hover:text-white">Daftar</a>
            <a href="{{route('login')}}" class="flex items-center justify-center text-sm/7 font-semibold text-[#4B5945] px-8 py-2 rounded-md bg-[#B2C9AD] hover:bg-[#91AC8F] hover:text-white">Masuk</a>
        </div>
        </nav>
    </header>
    <!----Header-->
        ...
        <!-- Spacer -->
        <div class="h-0"></div> <!-- Tambahkan spacer untuk mencegah konten tertutup header -->
            ...
            <div class="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:flex lg:h-full lg:items-center lg:px-8">
                ...
                <p class="mt-4 max-w-lg text-white sm:text-xl">
                    Jadikan hai-bu sebagai gerbang menuju penguasaan bahasa daerahmu. Ayo, mulai penjelajahan bahasamu saat ini juga!
                </p>
            
                <div class="mt-6 flex flex-col sm:flex-row gap-4">
                    <a
                    href="{{ route('register') }}"
                    class="block w-full sm:w-auto rounded bg-[#4B5945] hover:bg-[#B2C9AD] hover:text-[#4B5945] px-8 py-3 text-sm font-medium active:text-[#4B5945] text-white shadow focus:outline-none flex items-center justify-center"
                    >
                    Mulai Belajar
                    </a>
        ...
        <div>
            ...
            <h2 class="text-2xl font-semibold text-[#4B5945] sm:text-3xl">
                Apa itu hai-bu?
            </h2>

            <p class="mt-4 text-[#91AC8F] text-xl">
                Hai-bu hadir sebagai jembatan yang menghubungkanmu dengan keindahan dan keunikan bahasa daerah. 
                Platform ini dirancang untuk mengajak kamu menyelami petualangan linguistik yang memukau, 
                menjelajahi dialek-dialek lokal yang kaya akan nuansa budaya.
            </p>
            </div>
        </div>
        ...
        <!---About Us-->
            ...
            <!---Fun-fact--->
        <section id="fun-fact">
            <div class="mt-8 mb-10 ml-4 flex space-x-4 overflow-x-auto pb-4">
                <article class="flex-shrink-0 w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                    <img alt="" src="{{asset('image/jawa.png')}}" class="h-56 w-full object-cover" />
                    <div class="bg-white p-6">
                    <h2 class="mt-0.5 text-xl text-[#4B5945]">Bahasa Jawa</h2>
                    <p class="mt-2 line-clamp-3 text-sm/relaxed text-[#91AC8F]">Bahasa dengan jumlah penutur terbesar di Indonesia, dengan lebih dari 80 juta penutur</p>
                    </div>
                </article>

                <article class="flex-shrink-0 w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                <img alt="" src="{{asset('image/suku-sunda.jpg')}}"  class="h-56 w-full object-cover" />
                <div class="bg-white p-6">
                    <h2 class="mt-0.5 text-xl text-[#4B5945]">Bahasa Sunda</h2>
                    <p class="mt-2 line-clamp-3 text-sm/relaxed text-[#91AC8F]">Memiliki sistem tingkat tutur (unggah-ungguh) yang sangat kompleks, dengan setidaknya 6 level bahasa berbeda</p>
                </div>
            </article>

            <article class="flex-shrink-0 w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                <img alt="" src="{{asset('image/madura.jpeg')}}"  class="h-56 w-full object-cover" />
                <div class="bg-white p-6">
                    <h2 class="mt-0.5 text-xl text-[#4B5945]">Bahasa Madura</h2>
                    <p class="mt-2 line-clamp-3 text-sm/relaxed text-[#91AC8F]">Memiliki hubungan linguistik yang dekat dengan bahasa-bahasa di Kepulauan Filipina</p>
                </div>
            </article>

            <article class="flex-shrink-0 w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
            <img alt="" src="{{asset('image/melayu.jpg')}}"  class="h-56 w-full object-cover" />
            <div class="bg-white p-6">
                <h2 class="mt-0.5 text-xl text-[#4B5945]">Bahasa Melayu</h2>
                <p class="mt-2 line-clamp-3 text-sm/relaxed text-[#91AC8F]">Digunakan di beberapa negara seperti Indonesia, Malaysia, Brunei, dan Singapura</p>
            </div>
        </article>

            <article class="mr-4 flex-shrink-0 w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
            <img alt="" src="{{asset('image/minangkabau.jpg')}}"  class="h-56 w-full object-cover" />
            <div class="bg-white p-6">
                <h2 class="mt-0.5 text-xl text-[#4B5945]">Bahasa Minangkabau</h2>
                <p class="mt-2 line-clamp-3 text-sm/relaxed text-[#91AC8F]">Memiliki dialek yang sangat beragam, bahkan antarwilayah dalam satu provinsi</p>
            </div>
            </article>
            </div>  
        </section>    
        ...
        <section id="footer">
            ...
            <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                ...
                <div>
                    ...
                    <img class="h-12 w-auto" src="{{asset('image/hai-bu.png')}}" alt="Hai Bu">
                        <path
                    ...
                    <p class="mt-4 max-w-xs text-[#91AC8F]">
                    Temukan keunikan bahasa daerah dan jelajahi cerita budaya di balik setiap kata bersama hai-bu.
                    </p>
                    ...
                    >
                        ...
                        <path
                            d="M16.728 14.3c-.278-.139-1.647-.812-1.902-.905-.255-.092-.44-.139-.625.139-.185.277-.719.905-.882 1.089-.162.185-.324.208-.601.069-.278-.139-1.174-.432-2.234-1.38-.824-.731-1.38-1.634-1.544-1.912-.162-.278-.017-.428.123-.568.127-.126.277-.325.416-.488.139-.162.185-.278.278-.463.092-.185.046-.347-.023-.486-.07-.139-.624-1.505-.854-2.06-.223-.536-.449-.463-.624-.47h-.531c-.185 0-.485.07-.74.348-.255.278-.97.947-.97 2.302 0 1.354.993 2.662 1.13 2.85.139.185 1.954 2.99 4.742 4.181.662.278 1.178.445 1.58.569.663.21 1.265.18 1.74.11.53-.079 1.647-.672 1.88-1.324.232-.653.232-1.21.162-1.324-.07-.115-.255-.185-.531-.324zM12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18.333c-4.597 0-8.333-3.736-8.333-8.333S7.403 3.667 12 3.667 20.333 7.403 20.333 12 16.597 20.333 12 20.333z"
                        />
                        </svg>
                    </a>
                    </li>
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                    <div>
                    <p class="font-medium text-[#4B5945]">Fitur</p>
            
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Kuis </a>
                        </li>
            
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Tantangan </a>
                        </li>
                    ...
                    <div>
                    <p class="font-medium text-[#4B5945]">Kenapa pilih hai-bu?</p>
            
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Interaktif </a>
                        </li>
            
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Berarti </a>
                        </li>
            
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Menyenangkan </a>
                        </li>
                    </ul>
                    </div>
                    
                    <div>
                    <p class="font-medium text-[#4B5945]">Kebijakan</p>
            
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Kebijakan Privasi </a>
                        </li>
            
                        <li>
                        <a href="#" class="text-[#4B5945] transition hover:opacity-75"> Syarat & Ketentuan </a>
                        </li>
                    </ul>
                    </div>
                </div>
